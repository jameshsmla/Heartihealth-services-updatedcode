...
public class TotalPredictionWeeklyDTO {
	...
	public TotalPredictionWeeklyDTO() {
		
	}
	
	public TotalPredictionWeeklyDTO(String interval, int totalPrediction, int variation, boolean up) {
		super();
